...
const I = b(
  ({ children: n, isActive: y, tabIndex: s, className: c, as: m, disabled: d, to: l, isExternal: t, ...o }, p) => {
    t = t ?? (o == null ? void 0 : o.target) === "_blank";
    const f = r(N, (i) => i.isActiveItem), z = r(k, (i) => i.onItemActive), u = y ?? f(l);
    return x(() => {
      u && z();
    }, [u, z]), v(
      m ?? "a",
      ...
      /* @__PURE__ */ a("li", { className: "uizz-layout-box-border uizz-layout-grid uizz-layout-cursor-pointer uizz-layout-grid-cols-[1.625rem_1fr] uizz-layout-items-center uizz-layout-gap-2 uizz-layout-whitespace-nowrap uizz-layout-px-4 uizz-layout-py-1 uizz-layout-leading-[1.2] uizz-layout-no-underline uizz-layout-transition-[left,_background-color] xl:uizz-layout-py-[0.07rem]", children: [
        /* @__PURE__ */ e(
          h,
          {
        ...
        /* @__PURE__ */ a("div", { className: "uizz-layout-flex uizz-layout-items-center uizz-layout-justify-between", children: [
