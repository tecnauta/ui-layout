  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      <div className='uizz-layout-relative uizz-layout-box-border uizz-layout-h-auto xl:uizz-layout-w-[var(--eduzz-ui-layout-sidebar-width-rem)]'>
        ...
        <aside
          className={cx(
            'uizz-layout-fixed uizz-layout-inset-y-0 uizz-layout-left-[calc(var(--eduzz-ui-layout-sidebar-width-rem)*-1)] uizz-layout-z-[104] uizz-layout-inline-flex uizz-layout-w-[var(--eduzz-ui-layout-sidebar-width-rem)] uizz-layout-grow uizz-layout-flex-col uizz-layout-bg-white uizz-layout-shadow-[0px_4px_8px_rgba(0,0,0,0.16)] uizz-layout-transition-all xl:uizz-layout-left-0 xl:uizz-layout-bg-[rgb(252,252,252)]  xl:uizz-layout-shadow-none',
            {
