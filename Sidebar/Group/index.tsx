  ...
  ({ id, children, label, tabIndex, className }, ref) => {
    ...
    return (
      <SidebarGroupContext.Provider value={contextValue}>
        <li id={id} className={cx(className, 'uizz-layout-block uizz-layout-select-none')} ref={ref}>
          {!!label && (
            <div
              className='uizz-layout-relative uizz-layout-box-border uizz-layout-grid uizz-layout-min-h-[2.2rem] uizz-layout-cursor-pointer uizz-layout-grid-cols-[1.625rem_1fr] uizz-layout-items-center uizz-layout-gap-2 uizz-layout-rounded-br-[50px] uizz-layout-rounded-tr-[50px] uizz-layout-px-4 uizz-layout-py-2 uizz-layout-leading-[1.15] uizz-layout-outline-none uizz-layout-transition-all hover:uizz-layout-bg-content-6/[0.03] active:uizz-layout-bg-content-6/[0.03] dark:hover:uizz-layout-bg-content-6/[0.08] dark:active:uizz-layout-bg-content-6/[0.03] '
            ...
            >
              ...
              <div className='uizz-layout-col-[2] uizz-layout-min-w-0'>
                <span className='uizz-layout-overflow-hidden uizz-layout-text-ellipsis uizz-layout-whitespace-nowrap uizz-layout-break-all uizz-layout-text-sm uizz-layout-uppercase uizz-layout-tracking-[0.03em] uizz-layout-text-content-6/[0.65]'>
                  {label}
                </span>
              </div>
            </div>
