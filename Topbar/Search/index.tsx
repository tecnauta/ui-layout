    ...
    <Portal target={container}>
      <div className='uizz-layout-relative uizz-layout-box-border uizz-layout-hidden uizz-layout-h-10 uizz-layout-flex-1 uizz-layout-items-center uizz-layout-justify-between uizz-layout-gap-3 uizz-layout-px-2 uizz-layout-py-1 lg:uizz-layout-flex'>
        ...
        <input
          ref={inputRef}
          className={cx(
            'uizz-layout-h-10 uizz-layout-flex-1 uizz-layout-border-none uizz-layout-bg-transparent uizz-layout-text-base uizz-layout-text-content-6 focus-visible:uizz-layout-outline-none [&:focus+div]:uizz-layout-border-[var(--eduzz-theme-primary)] [&:focus+div]:uizz-layout-outline-2 [&:hover+div]:uizz-layout-border-[var(--eduzz-theme-primary)]',
            {
