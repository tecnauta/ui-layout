...
import w from "../../../hooks/useBoolean.js";
import v from "../../../Icons/Close.js";
import k from "../../../Icons/Fullscreen.js";
import { cn as d } from "../../../utils/cn.js";
const M = g(({ currentApplication: n, applications: o, opened: a, onClose: p, ...s }) => {
  const [l, i, , m] = w(), c = f(h, (u) => u.layout.mode), x = b((u, z) => {
    const r = new URL(u);
    return r.searchParams.set("eduzzMode", z), r.href;
  }, []);
  return y(() => {
            ...
            return /* @__PURE__ */ e(
              "a",
              {
                className: d(
                  ...
                  z && "uizz-layout-bg-content-title/[0.03] dark:uizz-layout-bg-content-title/[0.06]"
                ),
                href: z ? void 0 : x(u.url, c),
