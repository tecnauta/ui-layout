...
const AppsDropdown = memo<AppsDropdownProps>(({ currentApplication, applications, opened, onClose, ...rest }) => {
  ...
  return (
    <div
      className={cx(
        'uizz-layout-group/apps uizz-layout-invisible uizz-layout-fixed uizz-layout-left-0 uizz-layout-top-[var(--eduzz-ui-layout-topbar-height-rem)] uizz-layout-z-[105] uizz-layout-box-border uizz-layout-max-h-[calc(100vh-var(--eduzz-ui-layout-topbar-height-rem))] uizz-layout-w-full uizz-layout-select-none uizz-layout-overflow-y-auto uizz-layout-rounded-[0_0_0.5rem_0.5rem] uizz-layout-bg-background-4 uizz-layout-shadow-[0px_8px_24px_rgb(var(--eduzz-ui-layout-content-color-6)_/_0.16)] sm:uizz-layout-left-2 sm:uizz-layout-w-[var(--eduzz-ui-layout-topbar-app-dropdown-width-rem)]',
        {
    ...
    >
      ...
      <div className='uizz-layout-box-border uizz-layout-grid uizz-layout-grid-cols-[repeat(2,1fr)] uizz-layout-flex-wrap uizz-layout-justify-items-center uizz-layout-gap-[0.5rem_0.5rem] uizz-layout-p-4 group-[.--expanded]/apps:uizz-layout-grid-cols-[1fr] group-[.--expanded]/apps:uizz-layout-gap-0 group-[.--expanded]/apps:uizz-layout-p-0 sm:uizz-layout-grid-cols-[repeat(3,1fr)] sm:group-[.--expanded]/apps:uizz-layout-grid-cols-[repeat(2,1fr)] sm:group-[.--expanded]/apps:uizz-layout-gap-6 sm:group-[.--expanded]/apps:uizz-layout-p-6 lg:group-[.--expanded]/apps:uizz-layout-grid-cols-[repeat(3,1fr)] xl:group-[.--expanded]/apps:uizz-layout-grid-cols-[repeat(4,1fr)]'>
        ...
        {applications?.map(app => {
          ...
          return (
            <a
              className={cx(
                'uizz-layout-box-border uizz-layout-block uizz-layout-w-full uizz-layout-cursor-pointer uizz-layout-grid-cols-[2rem_1fr] uizz-layout-grid-rows-[1.5rem_auto] uizz-layout-gap-1 uizz-layout-rounded uizz-layout-border-gray-200 uizz-layout-px-2  uizz-layout-py-4 uizz-layout-text-inherit uizz-layout-no-underline visited:uizz-layout-text-inherit hover:uizz-layout-bg-content-6/[0.03] hover:uizz-layout-text-inherit group-[.--expanded]/apps:uizz-layout-grid group-[.--expanded]/apps:uizz-layout-border-b group-[.--expanded]/apps:uizz-layout-p-4 dark:uizz-layout-border-neutral-800 dark:hover:uizz-layout-bg-content-6/[0.06] sm:uizz-layout-grid-cols-[4rem_1fr] sm:group-[.--expanded]/apps:uizz-layout-border',
                isCurrent && 'uizz-layout-bg-content-6/[0.03] dark:uizz-layout-bg-content-6/[0.06]'
              )}
              key={app.application}
            ...
            >
              ...
              <p className='uizz-layout-col-span-2 uizz-layout-m-0 uizz-layout-mt-0.5 uizz-layout-hidden uizz-layout-overflow-hidden uizz-layout-text-base uizz-layout-leading-normal uizz-layout-text-content-6/[0.45] uizz-layout-opacity-80 group-[.--expanded]/apps:uizz-layout-block sm:uizz-layout-col-span-1 sm:uizz-layout-col-start-2'>
                {app.description}
              </p>
            </a>
          );
      ...
      {!!applications?.length && (
        <button
          className='uizz-layout-flex uizz-layout-h-[50px] uizz-layout-w-full uizz-layout-cursor-pointer uizz-layout-flex-row uizz-layout-items-center uizz-layout-justify-center uizz-layout-gap-2 uizz-layout-border-none uizz-layout-bg-transparent uizz-layout-text-content-6 uizz-layout-transition-all hover:uizz-layout-bg-content-6/[0.04] group-[.--expanded]/apps:uizz-layout-hidden'
          onClick={toggleExpanded}
        >
          <IconFullscreen />
          Expandir
